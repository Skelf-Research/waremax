...
impl ChartGenerator {
    ...
    pub fn generate_all(
        ...
        if let Some(ref stations) = report.station_reports {
            if !stations.is_empty() {
                ...
                if self
                    .generate_station_utilization_chart(stations, &path)
                    .is_ok()
                {
        ...
        if let Some(ref congestion) = report.congestion {
            if !congestion.top_congested_nodes.is_empty() {
                ...
                if self
                    .generate_congestion_ranking_chart(&congestion.top_congested_nodes, &path)
                    .is_ok()
                {
    ...
    fn generate_robot_utilization_chart(
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .build_cartesian_2d(0usize..robots.len(), 0.0..max_util)?;
        ...
        chart.draw_series(robots.iter().enumerate().map(|(i, r)| {
            ...
            Rectangle::new([(i, 0.0), (i + 1, r.utilization)], color.filled())
        }))?;
    ...
    fn generate_station_utilization_chart(
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .y_label_area_size(50)
            .build_cartesian_2d(0usize..stations.len(), 0.0..max_util)?;
        ...
        chart.draw_series(stations.iter().enumerate().map(|(i, s)| {
            ...
            Rectangle::new([(i, 0.0), (i + 1, s.utilization)], color.filled())
        }))?;
    ...
    fn generate_queue_length_chart(
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .x_label_area_size(40)
            .y_label_area_size(50)
            .build_cartesian_2d(0.0..max_time, 0usize..(max_queue + 1))?;
    ...
    fn generate_throughput_chart(
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .x_label_area_size(40)
            .y_label_area_size(50)
            .build_cartesian_2d(0i64..(max_time + 1), 0u32..(max_throughput + 1))?;
    ...
    fn generate_congestion_ranking_chart(
        ...
        let mut chart = ChartBuilder::on(&root)
            ...
            .build_cartesian_2d(0usize..top_n.len(), 0.0..max_score)?;
        ...
        chart.draw_series(top_n.iter().enumerate().map(|(i, r)| {
            ...
            Rectangle::new([(i, 0.0), (i + 1, r.score)], color.filled())
        }))?;
...
pub fn bar_chart_to_png_bytes(
    ...
    let mut buffer = vec![0u8; (width * height * 3) as usize];
    {
        ...
        chart.draw_series(
            data.iter()
                .enumerate()
                .map(|(i, (_, v))| Rectangle::new([(i, 0.0), (i + 1, *v)], BLUE.filled())),
        )?;
