...
impl ScenarioPreset {
    ...
    pub fn builder(&self) -> ScenarioBuilder {
        match self {
            ScenarioPreset::Minimal => ScenarioBuilder::new()
                .grid(3, 3)
                .robots(1)
                .pick_stations(1)
                .order_rate(10.0)
            ...
            ScenarioPreset::Quick => ScenarioBuilder::new()
                .grid(5, 5)
                .robots(3)
                .pick_stations(2)
                .order_rate(30.0)
            ...
            ScenarioPreset::Standard => ScenarioBuilder::new()
                .grid(10, 10)
                .robots(10)
                .pick_stations(4)
                .order_rate(60.0)
            ...
            ScenarioPreset::HighLoad => ScenarioBuilder::new()
                .grid(20, 20)
                .robots(50)
                .pick_stations(10)
            ...
            ScenarioPreset::PeakHours => ScenarioBuilder::new()
                .grid(15, 15)
                .robots(20)
                .pick_stations(6)
                .station_concurrency(2)
            ...
            ScenarioPreset::StressTest => ScenarioBuilder::new()
                .grid(30, 30)
                .robots(100)
                .pick_stations(20)
            ...
            ScenarioPreset::BatteryTest => ScenarioBuilder::new()
                .grid(10, 10)
                .robots(15)
                .pick_stations(4)
                .order_rate(60.0)
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name.to_lowercase().as_str() {
            ...
            "maintenance_test" | "maintenancetest" | "maintenance" => {
                Some(ScenarioPreset::MaintenanceTest)
            }
            _ => None,
        }
    }
...
mod tests {
    ...
    fn test_all_presets_build_successfully() {
        for preset in ScenarioPreset::all() {
            ...
            assert!(
                config.robots.count > 0,
                "Preset {:?} should have robots",
                preset
            );
            assert!(
                !config.stations.is_empty(),
                "Preset {:?} should have stations",
                preset
            );
        }
    }
    ...
    fn test_preset_from_name() {
        assert_eq!(
            ScenarioPreset::from_name("quick"),
            Some(ScenarioPreset::Quick)
        );
        assert_eq!(
            ScenarioPreset::from_name("QUICK"),
            Some(ScenarioPreset::Quick)
        ...
        assert_eq!(
            ScenarioPreset::from_name("stress_test"),
            Some(ScenarioPreset::StressTest)
        );
        assert_eq!(
            ScenarioPreset::from_name("stresstest"),
            Some(ScenarioPreset::StressTest)
        );
